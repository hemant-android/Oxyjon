...
import app.oxyjon.databinding.ActivityPlanDetailScreenBinding
...
import app.oxyjon.ui.kotlin.activity.adapter.HealthPlanDetailCareTeamAdapter
...
class PlanDetailActivity : BaseActivity(), IApiCallback, PaymentResultWithDataListener {

    lateinit var binding: ActivityPlanDetailScreenBinding
    ...
    private val mCareTeamAdapter: HealthPlanDetailCareTeamAdapter by lazy {
        HealthPlanDetailCareTeamAdapter(this)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPlanDetailScreenBinding.inflate(layoutInflater)
    ...
    private fun buyPlan(
        ...
        setUserAttribute(this, "subscription_health_plan_name", planTitle!!)
        setUserAttribute(this, "subscription_health_plan_price", planPrice!!)
            ...
            if (response.isSuccessful) {
                if (response.body()!!.errorCode == "0") {
                    ...
                    if (response.body()!!.healthplan_details != null) {
                        ...
                        if (response.body()!!.healthplan_details.plan_title == "Doctor consultation" || response.body()!!.healthplan_details.plan_title == "Diet planning") {
                            binding.tvDuration.visibility = View.GONE
                            binding.tvPlanValid.visibility = View.GONE
                        } else {
                            binding.tvDuration.visibility = View.VISIBLE
                            binding.tvPlanValid.visibility = View.VISIBLE
                        ...
                        if (response.body()!!.healthplan_details.banner != null && !TextUtils.isEmpty(
                                response.body()!!.healthplan_details.banner
                            )
                        ) {
                            binding.imgDiscount.visibility = View.VISIBLE
                            try {
                                Glide.with(this@PlanDetailActivity)
                                    .load(response.body()!!.healthplan_details.banner)
                                    .placeholder(R.drawable.progress_animation)
                                    .into(binding.imgDiscount!!)
                            } catch (e: Exception) {
                                e.printStackTrace()
                            }
                        } else {
                            binding.imgDiscount.visibility = View.GONE
                        }
    ...
    override fun onPaymentSuccess(razorpayPaymentID: String?, paymentData: PaymentData?) {
        ...
        mFirebaseAnalytics!!.logEvent("BuyHealthPlan", bundle)
        mFirebaseAnalytics!!.setDefaultEventParameters(bundle)

        mFirebaseAnalytics!!.setUserProperty("BuyHealthPlan", "Success")

        setUserAttribute(this, "subscription_buy_health_plan_status", "Success")
    ...
    override fun onPaymentError(code: Int, response: String?, paymentData: PaymentData?) {
        ...
        setUserAttribute(this, "subscription_buy_health_plan_status", "Fail")
