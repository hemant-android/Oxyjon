...
class WeightReport  : Parcelable {
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<WeightReport?> = object : Parcelable.Creator<WeightReport?> {
            public override fun createFromParcel(`in`: Parcel): WeightReport? {
                return WeightReport(`in`)
            }

            public override fun newArray(size: Int): Array<WeightReport?> {
